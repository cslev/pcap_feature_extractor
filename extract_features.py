...
log(f"Tshark (PACKET_LEVEL): {format_time(int(tshark_packet_level_thread_stop - tshark_packet_level_thread_start))}")
log(f"Tshark (FLOW_LEVEL_L3): {format_time(int(tshark_flow_l3_thread_stop - tshark_flow_l3_thread_start))}")
log(f"Tshark (FLOW_LEVEL_L4_UDP): {format_time(int(tshark_flow_l4_udp_thread_stop - tshark_flow_l4_udp_thread_start))}")
log(f"Tshark (FLOW_LEVEL_L4_UDP): {format_time(int(tshark_flow_l4_tcp_thread_stop - tshark_flow_l4_tcp_thread_start))}")
log(f"Tshark (ENDPOINTS): {format_time(int(tshark_endpoint_stop - tshark_endpoint_start))}")